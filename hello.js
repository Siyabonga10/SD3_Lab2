...
const filterByElective = function (targetElective) {
  const targetStudents = students.filter((student) => {
    const index = student.electives.findIndex((elective) => { return elective === targetElective })
    if (index === -1 || student.yearOfStudy !== 4) { return false }
    return true
  })
...
const ELEN4010Students = filterByElective(electiveOne)
console.log(ELEN4010Students)
